  ...
  return (
    <section className="sticky top-0 flex flex-col gap-10 bg-white border-r px-5 py-3 h-screen overflow-hidden w-[260px] z-50">
      <div className="flex justify-center">
        <Link href={`/`}>
          <img className="h-20" src="/Marxio.jpg" alt="" />
        </Link>
      </div>
      ...
      <div className="flex justify-center">
        <button
          ...
          className="flex gap-2 items-center px-3 py-2 hover:bg-orange-100 rounded-xl w-full justify-center ease-soft-spring duration-400 transition-all"
        >
  ...
  return (
    <Link href={item?.link}>
      <li
        ...
        ${isSelected ? "bg-orange-300 text-white" : "bg-white text-black"} 
        `}
      >
        {item?.icon} {item?.name}
      </li>
