...
export default function CategorySection() {
  return (
    <div className="max-w-[1200px] mx-auto mt-16 mb-0 h-[500px]"> {/* Reduced mt-32 to mt-16 and added mb-0 */}
      <div className="grid grid-cols-3 grid-rows-2 gap-3 items-center">
        <div className="flex flex-col gap-3">
          <Link href={categories[0].link} className="group">
            <img
              src={categories[0].imgSrc}
              alt="Category 1"
              className="w-full border-8 border-orange-300 h-[200px] object-cover transition-transform duration-300 group-hover:scale-105"
            />
          </Link>
        ...
        <Link href={categories[2].link} className="group">
          <img
            ...
            alt="Category 3"
            className="w-full border-8 border-orange-300 h-[400px] object-cover transition-transform duration-300 group-hover:scale-105"
          />
        </Link>
